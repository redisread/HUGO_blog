...
- Before publishing, run `hugo` and inspect obvious build errors.
...
Keep this file short. Move long shortcode examples or theme-specific notes into `.claude/rules/` or docs.
