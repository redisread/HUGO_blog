---
title: Superset 最佳实践：AI Agent 并行编排完全指南
date: 2026-03-11 16:45:00
publishDate: 2026-03-11 16:45:00
description: 详解如何使用 Superset 在单机上同时运行 10+ 个 Claude Code、Codex 等 Agent，涵盖 Git worktree 机制、Workspace 设计、Setup/Teardown 配置、Agent 并行策略与 Review 工作流
...
Superset 是一个基于 Git worktree 的 AI Agent 并行编排工具，让你可以在单机上同时运行 10+ 个 Claude Code、Codex、Cursor 等 Agent，而不会互相踩脚。本文从核心机制到实战配置，提供一份完整的使用指南。

---

## 一、理解核心机制：Git Worktree
